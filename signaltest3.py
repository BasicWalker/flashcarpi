...
class obdWorker(QtCore.QThread):
    '''
    OBD Worker thread
    ...
    def read(self):
        ...
        self.obd_reading.emit((speed, rpm1))
...
class MainWindow(QMainWindow, Ui_MainWindow):
    ...
    def run_obd_thread(self):
        self.obdthread = obdWorker()
        self.obdthread.start()
        self.obdthread.obd_reading.connect(self.update_car)
